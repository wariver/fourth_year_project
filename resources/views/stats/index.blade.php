            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">More Actions</div>
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    <button class="btn btn-sm btn-outline-success">Load Bike </button>
                                </div>
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    <button class="btn btn-sm btn-outline-success">Went for Service?</button>
                                </div>
